async function draw() {
  ...
  ctr
    ...
    .on("mouseenter", function (event, datum) {
      ...
      tooltip.select(".stop-name").text(((d) => d.stop)(datum));

      tooltip.select(".elevation span").text(formatter(yAccessor(datum)));
    })
  ...
  const yAxisGroup = ctr.append("g").call(yAxis).select(".domain").remove();
